window.LOJANOVA_NOTICIAS_DESTACADAS = [
  {
    slug: "loja-hacia-emiratos-arabes-unidos-2026",
    titulo: "Loja hacia Emiratos Árabes Unidos",
    subtitulo: "Oportunidades, negocios y estrategias para ingresar al mercado emiratí",
    resumen: "Taller presencial para conocer el mercado emiratí, identificar oportunidades y preparar productos lojanos para nuevos compradores.",
    tipo: "capacitacion",
    ...
    temario: [
      ...
      { titulo: "Aprenda a negociar", detalle: "¿Cómo hacer negocios en Emiratos?" },
      { titulo: "Conozca los números", detalle: "Comercio Ecuador–Emiratos y oportunidades." },
      { titulo: "Encuentre al comprador", detalle: "¿Quién puede comprar su producto?" },
      { titulo: "Prepare su producto", detalle: "¿Está su producto listo para Emiratos?" },
      { titulo: "Póngalo en práctica", detalle: "Caso práctico: de Ecuador al mercado emiratí." },
      { titulo: "Convierta la oportunidad en negocio", detalle: "¿Cómo puede CCEATI acompañar a su empresa?" }
    ]
  },
  {
    slug: "loja-exporta-2026-ruta-hacia-el-mundo",
    titulo: "Loja abre una ruta hacia el mundo",
    subtitulo: "Loja Exporta 2026 y el impulso digital de Lojanova",
    resumen: "Dos jornadas conectaron a más de 80 productores lojanos con delegaciones, cámaras y aliados internacionales, y abrieron una agenda de seguimiento que continúa en el entorno digital.",
    tipo: "rueda_negocios",
    fecha_evento: "2026-07-31",
    lugar: "Teatro Benjamín Carrión, Loja",
    ...
    secciones: [
      ...
      { titulo: "Cuando el producto cuenta la historia del territorio", contenido: "Degustaciones, empaques, relatos de origen y demostraciones hicieron tangible la conversación comercial. La calidad, la identidad y el origen de cada producto se convirtieron en cartas de presentación de la provincia." },
      { titulo: "El día después de la rueda de negocios", contenido: "El reto continúa con talleres gratuitos, seguimiento de contactos, actualización de información productiva y acompañamiento técnico. Registrar intereses, requisitos y acciones pendientes es esencial para convertir la visibilidad en oportunidades verificables." },
      { titulo: "De Loja a Shanghái", contenido: "Tras el encuentro, una selección de productos presentados en Loja Exporta 2026 llegó a Shanghái. La misión, encabezada por Santiago Idrobo, incluyó una visita al Consulado General del Ecuador y extendió la conversación hacia uno de los principales centros económicos de Asia." },
      { titulo: "Lojanova: la vitrina que prolonga el encuentro", contenido: "Lojanova mantiene disponible la oferta de productos, categorías, cantones y perfiles de emprendedores. No funciona como tienda en línea: organiza la oferta, fortalece la identidad de origen y facilita el descubrimiento y el contacto directo." },
      { titulo: "La arquitectura digital de Lojanova", contenido: "José Valverde ideó y desarrolló la plataforma desde la conceptualización hasta su estructura, diseño, funcionalidades y propuesta de posicionamiento. El proyecto integró herramientas web, bases de datos y sistemas de administración para gestionar productos, emprendedores, noticias y contenidos." },
      { titulo: "El pulso digital", contenido: "Entre el 25 de julio y el 8 de agosto de 2026, los quince valores visibles del panel sumaron 1.234 visitas. El pico fue de 209 visitas el 3 de agosto. Ecuador encabezó los registros visibles y también aparecieron señales desde Estados Unidos, España, Francia, China, Vietnam y Corea del Sur." },
      { titulo: "El producto concreto ganó la conversación", contenido: "Cuatro publicaciones verificadas el 8 de agosto reunieron 487 acciones públicas observables: 402 en Facebook y 85 en Instagram. Un reel sobre café concentró 297 acciones visibles. Estas métricas muestran atención y respuesta pública, pero no equivalen a personas únicas ni permiten afirmar cuántas ventas, acuerdos o exportaciones se produjeron." },
      { titulo: "Una agenda que continúa", contenido: "El encuentro instaló relaciones, la plataforma prolongó la visibilidad y los datos señalaron dónde existe atención. La siguiente etapa debe medirse en contactos atendidos, capacidades fortalecidas y oportunidades que avanzan con responsables y plazos definidos." }
    ],
    galeria: [
