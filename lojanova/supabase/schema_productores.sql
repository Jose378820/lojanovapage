...
-- =========================================================
-- Notas:
-- - Si en tu proyecto de Supabase tienes activada la confirmación de
--   correo (Authentication > Providers > Email > "Confirm email"),
--   el productor deberá confirmar su correo antes de poder iniciar
--   sesión. Puedes desactivar esa opción mientras pruebas.
-- - Puedes verificar que el trigger funcionó con:
--   select nombre, emprendimiento, auth_user_id from emprendedores
